  ...
  try {
    ...
    for (i = 1; i <= urls.length; i++) {
      ...
      try {
        ...
        await eyes.check(urls[i - 1].toString(), Target.window().fully().layout(By.css('#message-bar > div > div > div > div > div.cf-sw-inner-container.cf-mb-left-align > div.cf-sw-countdown-wrap')));
